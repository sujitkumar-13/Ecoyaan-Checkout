...
export function OrderSummary({
    ...
    return (
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl shadow-stone-200/50 border border-stone-100 flex flex-col gap-6 lg:sticky lg:top-28 overflow-hidden relative">
            ...
            <div className="relative z-10 w-full">
                ...
                <div className="flex justify-between items-center border-t border-stone-100 pt-5 mt-6">
                    ...
                    <span className="text-xl sm:text-2xl font-black text-green-700">{formatPrice(grandTotal)}</span>
                </div>
                ...
                {buttonText && onButtonClick && (
                    <button
                        ...
                        className="w-full mt-8 bg-green-600 hover:bg-green-700 text-white py-3.5 sm:py-4 px-6 rounded-xl font-bold transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 group shadow-lg shadow-green-100/50 active:scale-[0.98] text-sm sm:text-base"
                    >
                        {isLoading ? (
                ...
                <div className="mt-8 pt-6 border-t border-stone-50 flex items-center justify-center gap-3 text-stone-400 group cursor-default">
                    ...
                    <span className="text-[10px] sm:text-[11px] font-bold tracking-widest uppercase">Secure Checkout</span>
                </div>
            </div>
        </div>
    );
